...
def init():
    ...
    if os.getenv("environment") != "local":
        ...
        s3_client.download_file(S3_ARTIFACT_BUCKET_NAME, f"{S3_PREFECT_PATH}/{MODELS_PATH}/{MODEL_NAME}", MODEL_PATH)
    return tokenizer
...
def create_poem(baseline:str):
    ...
    preds = model.generate(inp, max_length=60, num_beams=5, no_repeat_ngram_size=2, early_stopping=True)
